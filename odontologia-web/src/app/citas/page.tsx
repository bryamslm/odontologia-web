          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="/" className="block text-gray-400 hover:text-rose-400">Inicio</a>
                <a href="/#servicios" className="block text-gray-400 hover:text-rose-400">Servicios</a>
                <a href="/#sobre-nosotros" className="block text-gray-400 hover:text-rose-400">Sobre nosotros</a>
