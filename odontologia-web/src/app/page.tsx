...
export default async function Page() {
  // Ejemplo: podrías hacer fetch a una API real para obtener data en SSR:
  /*
  const services = await fetch("https://api.tu-dominio.com/services", {
    cache: "no-store", // Forzar SSR sin cache
  }).then(res => res.json());
  */

  // O si tus datos son estáticos:
  const SERVICES = [
      {
  ...
  return (
    // Pasa los datos a tu componente cliente
